  ...
  return (
    <header className="">
      <div className="flex justify-between items-center pt-8 ">
        ...
        <Link to={'/search'} className={`w-96 flex border border-gray-300 rounded-full py-1 px-5 shadow-md shadow-gray-300 items-center ${location.pathname === '/search' ? 'hidden' : ''}`}>
          <input
